...
//    Disposer.register(displayProject, balloon);
  ...
  private JRootPane getProjectRootPane(@Nullable Project project) {
    ...
    if (true || (project != null) && project.isOpen()) {

      JFrame visibleFrame = WindowManager.getInstance().findVisibleFrame();
      whatIsIt(visibleFrame, "\n\nVisible Frame Project is: ");
      Window activeWindow = KeyboardFocusManager.getCurrentKeyboardFocusManager().getActiveWindow();
      whatIsIt(activeWindow, "Active Window Project is: ");
      Window focusedWindow = KeyboardFocusManager.getCurrentKeyboardFocusManager().getFocusedWindow();
      whatIsIt(focusedWindow, "Focused Window Project is: ");
      Component focusedComponent = KeyboardFocusManager.getCurrentKeyboardFocusManager().getFocusOwner();
      whatIsIt(focusedComponent, "Focused Component Project is: ");
  ...
  private void whatIsIt(Component c, String s) {
    Project proj = null;
    Component parent = UIUtil.findUltimateParent(c);
    if ((parent != null) && (parent instanceof IdeFrame)) {
      proj = ((IdeFrame) parent).getProject();
    }
    System.out.print(s);
    if (proj != null) {
