...
public class PhpStaticFactoryTypeProvider extends CompletionContributor implements PhpTypeProvider4 {
  ...
  private static final Context.Key< CachedValue< Iterators.Map< String, Iterators.Map<String, String> > > > STATIC_FACTORY_TYPE_MAP =
        new Context.Key< CachedValue< Iterators.Map<String, Iterators.Map<String, String> > > >("STATIC_FACTORY_TYPE_MAP");
